...
const IntroArray = () => {
  return (
    <div className="container mx-auto p-10 h-screen overflow-x-hidden overflow-y-auto">
      <h1 className="text-4xl font-bold mb-10">Introduction to Arrays</h1>
      <div className="mx-auto px-10">
        <h2 className="font-semibold text-[18px] mb-5">What is Array?</h2>
        <p className="mb-4">
        ...
        <p className="mb-4">
          An array in C is declared by specifying the data type of the elements
          in the array, followed by the name of the array, and then the size of
          the array in square brackets. For example, to declare an array of 10
          integers, you would use the following syntax:
        </p>
        <pre className="bg-gray-200 rounded-md p-2 mb-4">int arr[10];</pre>
        <p className="mb-4">
          Arrays in C are zero-indexed, which means that the first element in
          the array has an index of 0. You can access the elements in an array
          by using the array name followed by the index of the element in square
        ...
        <div>
          ...
          <p className="mb-2">
            Arrays can be initialized with values at decleration time using
            curly braces {`{}`}, like{" "}
          ...
          <p className="mb-2">
            Arrays can be pased to functions as arguments, either by reference
            or by value.
          </p>
        </div>
